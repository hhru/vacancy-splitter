...
public class TfIdfVectorizer implements Vectorizer<String> {
  ...
  public static class Builder {
    ...
    Builder(int threshold, Set<String> stopWords, boolean stem) {
